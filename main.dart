...
class _ElectroLexHomeState extends State<ElectroLexHome> {
  ...
  final List<Map<String, dynamic>> subcomponents = [
    ...
    {
      'title': 'Satellite Positioning Modules',
      'category': 'IoT\n   Communication',
      'icon': Icons.wifi,
      'color': Colors.tealAccent,
    },
    ...
    {
      'title': 'Darlington Transistor Array',
      'category': 'Display Drivers',
      'icon': Icons.display_settings,
      'color': Colors.cyan,
    },
                                ...
                                onTap: () {
                                  if (component['title'] == 'Buzzers') {
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (_) => EmulatorProgrammerPage(),
                                      ), // Navigate to CarbonFilmResistorPage
                                    );
                                  }
                                  else if (component['title'] ==
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (_) => BluetoothModulesPage(),
                                      ), // Navigate to CarbonFilmResistorPage
                                    );
                                  }
                                  else if (component['title'] ==
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (_) => SatellitePositioningModulesPage(),
                                      ), // Navigate to CarbonFilmResistorPage
                                    );
                                  }
                                  else if (component['title'] ==
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (_) => DarlingtonTransistorArrayPage(),
                                      ), // Navigate to CarbonFilmResistorPage
                                    );
                                  }else if (component['title'] ==
                                      'Driver ICs') {
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (_) => LCDDisplaysModulesPage(),
                                      ), // Navigate to CarbonFilmResistorPage
                                    );
                                  }else if (component['title'] ==
                                      'RLED Displays Drivers') {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (_) => LEDDisplaysDriversPage(),
                                      ), // Navigate to CarbonFilmResistorPage
                                    );
                                  }else if (component['title'] ==
                                      'LED Segment Display') {
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (_) => VFDDisplaysModulesPage(),
                                      ), // Navigate to CarbonFilmResistorPage
                                    );
                                  }else if (component['title'] ==
                                      'RF Amplifiers') {
